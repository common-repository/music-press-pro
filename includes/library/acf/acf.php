...
class acf_mp
{
	...
	*/
	...
	function init()
	{
		...
		$labels = array(
		    'name' => esc_html__( 'Field&nbsp;Groups', 'acf' ),
			'singular_name' => esc_html__( 'Advanced Custom Fields', 'acf' ),
		    'add_new' => esc_html__( 'Add New' , 'acf' ),
		    'add_new_item' => esc_html__( 'Add New Field Group' , 'acf' ),
		    'edit_item' =>  esc_html__( 'Edit Field Group' , 'acf' ),
		    'new_item' => esc_html__( 'New Field Group' , 'acf' ),
		    'view_item' => esc_html__('View Field Group', 'acf'),
		    'search_items' => esc_html__('Search Field Groups', 'acf'),
		    'not_found' =>  esc_html__('No Field Groups found', 'acf'),
		    'not_found_in_trash' => esc_html__('No Field Groups found in Trash', 'acf'),
		);
...
//			'acf-datepicker'	=> $this->settings['dir'] . 'core/fields/date_picker/style.date_picker.css',
	...
	*/
	...
	function admin_menu()
	{
		add_menu_page(__("Custom Fields",'acf'), esc_html__("Custom Fields",'acf'), 'manage_options', 'edit.php?post_type=acf', false, false, '80.025');
	}
	...
	*/
	...
	function post_updated_messages( $messages )
	{
		...
		$messages['acf'] = array(
			...
			1 => esc_html__('Field group updated.', 'acf'),
			2 => esc_html__('Custom field updated.', 'acf'),
			3 => esc_html__('Custom field deleted.', 'acf'),
			4 => esc_html__('Field group updated.', 'acf'),
			/* translators: %s: date and time of the revision */
			5 => isset($_GET['revision']) ? sprintf( esc_html__('Field group restored to revision from %s', 'acf'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6 => esc_html__('Field group published.', 'acf'),
			7 => esc_html__('Field group saved.', 'acf'),
			8 => esc_html__('Field group submitted.', 'acf'),
			9 => esc_html__('Field group scheduled for.', 'acf'),
			10 => esc_html__('Field group draft updated.', 'acf'),
		);

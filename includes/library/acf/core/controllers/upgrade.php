...
class acf_upgrade
{
	...
	*/
	...
	function admin_menu()
	{
		...
		// update admin page
		add_submenu_page('edit.php?post_type=acf', esc_html__('Upgrade','acf'), esc_html__('Upgrade','acf'), 'manage_options','acf-upgrade', array($this,'html') );
	}
		...
		switch($_POST['version'])
		{
			...
			*--------------------*/
			...
			case '3.2.5':
				...
				// vars
				$message = esc_html__("Modifying field group options 'show on page'",'acf') . '...';
			...
			*/
			...
			case '3.3.3':
				...
				// vars
				$message = esc_html__("Modifying field option 'taxonomy'",'acf') . '...';
			...
			*/
			...
			case '3.4.1':
				...
				// vars
				$message = esc_html__("Moving user custom fields from wp_options to wp_usermeta",'acf') . '...';

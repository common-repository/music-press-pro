...
class acf_export
{
	...
	*/
	...
	{
		// add page
		$page = add_submenu_page('edit.php?post_type=acf', esc_html__('Export','acf'), esc_html__('Export','acf'), 'manage_options', 'acf-export', array($this,'html'));
		...
		<tr>
			...
			<td>
				<ul class="hl clearfix">
					<li>
						<input type="submit" class="acf-button" name="export_to_xml" value="<?php esc_html_e("Export to XML",'acf'); ?>" />
					</li>
					<li>
						<input type="submit" class="acf-button" name="export_to_php" value="<?php esc_html_e("Export to PHP",'acf'); ?>" />
					</li>
				</ul>
			</td>
		</tr>

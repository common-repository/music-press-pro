	...
	*/
	...
	function create_field( $field )
	{
		...
		$args = array(
			...
			'hide_empty'   => false,
			'style'        => 'none',
			'walker'       => new acf_taxonomy_field_walker_mp( $field ),
		);
...
<div class="acf-taxonomy-field" data-load_save="<?php echo $field['load_save_terms']; ?>">
	...
	<div class="categorychecklist-holder tz_album_create">
		<div class="tzacf-checkbox-list">
		<label class="audio_album album"><?php esc_html_e("Audio Album",  'music-press-pro'); ?></label>
		<ul class="acf-checkbox-list">
			...
			foreach($terms as $term){
				...
				$album_type = get_option('tz_album_type'.$term->term_id);
				if($album_type =='audio'){ ?>
				<li>
					<label class="selectit">
						<input <?php if(in_array($term->term_id, $checked) ){echo "checked";} ?> type="<?php echo $field['field_type']; ?>" name="<?php echo $field['name']; ?>" value="<?php echo esc_attr($term->term_id);?>" /> <?php echo esc_attr($term->name); ?>
					</label>
				</li>
			<?php }
			}
		...
		<label class="audio_album album"><?php esc_html_e("Video Album",  'music-press-pro'); ?></label>
		<ul class="acf-checkbox-list">
			<?php if( $field['allow_null'] ): ?>
				<li>
					<label class="selectit">
...
class acf_taxonomy_field_walker_mp extends Walker
{
	// vars
	var $field = null,
		$tree_type = 'category',
